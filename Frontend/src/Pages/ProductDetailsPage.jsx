            ...
            <div className="flex gap-4 mt-5">
              {product.images?.map((img, index) => (
                <button
                  ...
                  className={`w-24 h-24 rounded-3xl overflow-hidden border transition-all duration-300 ${selectedImage === img ? "border-red-500 scale-105" : "border-white/40"
                    }`}
                >
                  <img
                    src={img}
          ...
          >
            ...
            <div className="mt-8 p-7 rounded-[32px] bg-white/70 backdrop-blur-xl border border-white/40 shadow-sm">
              <p className="text-gray-600 leading-8">
                ...
                and trusted quality craftsmanship.
              </p>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap items-center gap-5">
                ...
                <span className="text-gray-500 font-medium">
                  {product.stock || product.qty || 10} items available
                </span>
              </div>
            </div>
