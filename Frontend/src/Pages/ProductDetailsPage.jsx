...
const ProductDetailsPage = () => {
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#f7f7f5]">
        <div className="text-center">
          ...
          <button
            ...
            className="mt-6 px-6 py-3 bg-red-600 text-white rounded-full hover:bg-red-700 transition-colors font-medium"
          >
            Browse Products
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#f7f7f5] py-8 relative overflow-hidden">
      {/* Background Decoration */}
      <div className="absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-48 -left-36 w-[500px] h-[500px] bg-red-300/20 blur-3xl rounded-full" />
        <div className="absolute -bottom-48 -right-36 w-[500px] h-[500px] bg-orange-300/20 blur-3xl rounded-full" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <motion.button
              ...
              onClick={handleBack}
              className="flex items-center gap-2 px-4 py-2.5 bg-white/80 backdrop-blur-xl border border-white/40 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 group cursor-pointer"
            ...
            <nav className="hidden md:flex items-center gap-2 text-sm" aria-label="Breadcrumb">
              <button
                onClick={() => navigate("/")}
                className="text-gray-400 hover:text-red-600 transition-colors cursor-pointer flex items-center gap-1"
              >
                <Home size={14} />
                <span>Home</span>
              </button>
              ...
              <button
                onClick={() => navigate("/products")}
                className="text-gray-500 hover:text-red-600 transition-colors cursor-pointer font-medium"
              >
                Products
              </button>
              {product?.category && (
          ...
          {/* Category Badge */}
          {product?.category && (
            <span className="hidden sm:inline-block px-4 py-1.5 bg-red-50 text-red-600 rounded-full text-xs font-bold border border-red-100">
              {product.category}
            </span>
          )}
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          >
            <div className="relative bg-white/70 backdrop-blur-2xl rounded-[30px] border border-white/40 shadow-[0_20px_60px_rgba(0,0,0,0.08)] overflow-hidden">
              {/* Category Tag */}
              <div className="absolute top-4 left-4 z-20">
                <span className="bg-red-600 text-white px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-[0.15em] shadow-lg">
                  {product.category}
                </span>
              </div>
              ...
              {/* Rating Badge */}
              <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-md px-4 py-3 rounded-xl shadow-xl">
                <div className="flex items-center gap-1 text-yellow-500">
                  <Star size={14} fill="currentColor" />
                  <span className="text-sm font-black text-gray-900">4.9</span>
                </div>
                <p className="text-xs text-gray-500 mt-0.5">2k+ Reviews</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-gray-500 font-medium">(4.9 Reviews)</span>
            </div>

            {/* Title */}
            <h1 className="text-3xl md:text-4xl font-black tracking-tight leading-tight text-gray-900 mt-4">
              {product.name}
            </h1>

            {/* Tags */}
            <div className="flex flex-wrap items-center gap-2 mt-4">
              <span className="px-3 py-1.5 rounded-full bg-red-50 text-red-600 text-xs font-bold">
                Best Seller
              </span>
              <span className="px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold">
                In Stock
              </span>
              <span className="px-3 py-1.5 rounded-full bg-gray-100 text-gray-700 text-xs font-bold">
                Premium
              </span>
            </div>

            {/* Description */}
            <div className="mt-5 p-5 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/40 shadow-sm">
            ...
            <div className="mt-6 flex items-end gap-4">
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-red-600">
                ₹{product.price?.toLocaleString()}
              </h2>
              <span className="mb-1 bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full text-xs font-bold">
                Available
              </span>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div className="flex items-center bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                  ...
                  <div className="w-12 text-center font-black text-base">{quantity}</div>
                  <button
        ...
        {product.video && (
          <section className="mt-16">
            <div className="text-center mb-8">
              <p className="text-xs uppercase tracking-[0.2em] text-red-500 font-bold mb-1">
                Product Showcase
              </p>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="rounded-[30px] overflow-hidden bg-white shadow-[0_15px_40px_rgba(0,0,0,0.06)] border border-white/40"
            >
              <video
                src={product.video}
                controls
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {relatedProducts.map((item, index) => (
                <motion.div
                  ...
                  className="group cursor-pointer rounded-2xl overflow-hidden bg-white/80 backdrop-blur-xl border border-white/40 shadow-[0_8px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] transition-all duration-400"
                >
                  <div className="relative overflow-hidden aspect-square bg-gray-100">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="bg-white/90 backdrop-blur-md text-gray-700 text-[10px] uppercase tracking-[0.15em] font-bold px-2.5 py-1.5 rounded-full">
                        {item.category}
                      </span>
                    </div>
                  </div>
